...
class Vec2D
{
  public:
    ...
    /**
     * Initializes a 2D vector of given width and height, filled with the provided default value (if
     * provided).
     */
     ...
     * Returns an std::optional containing the position of the element if found, or an empty
     * std::optional if not found.
     */
